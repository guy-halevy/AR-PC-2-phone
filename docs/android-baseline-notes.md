...
Tools: JDK 17, Gradle versions from each pinned wrapper, SDK 34, NDK 25.2.9519653, Rust 1.85.1, cargo-ndk 0.9.0, cbindgen 0.26.0. CI resolves and compiles these rather than assuming success. This first artifact is arm64 only, debug signed, and requires Android API 26 for the ALVR native path. It is not a universal phone release.
